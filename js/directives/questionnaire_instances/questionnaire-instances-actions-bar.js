angular.module("Questionnaire")
    .directive("questionnaireInstancesActionsBar", function(YesNoCancelDialog) {
        return {
            restrict: 'E',
            templateUrl: 'templates/pages/questionnaire_instances/questionnaire-instances-actions-bar.html',
            scope: {
